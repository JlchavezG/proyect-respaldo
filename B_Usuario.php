...
if (empty($_POST['submit'])) {
    $valor = $_POST['Numero'];
    if (!empty($valor)) {
       $where = "WHERE User_Reg LIKE '%$valor%'";
    }
}
// consulta inner join
      ...
      <div id="page-content-wrapper">
           ...
           <?php include 'includes/calendario.php'; ?>
             <div class="container-fluid">
                 ...
                 <h3 class="mt-4 text text-center">Consulta de Asignaciones por usuario</h3>
                           ...
                           <div class="card-body">
                             <div class="row">
                              ...
                              <form class="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                <input type="text" name="Numero" class="form-control" placeholder="Busqueda por Usuario">
