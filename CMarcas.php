...
$buscar = "SELECT * FROM Marcas $where";
      ...
      <div id="page-content-wrapper">
           ...
           <?php include 'includes/calendario.php'; ?>
             <div class="container-fluid">
                 ...
                 <h3 class="mt-4 text text-center">Consulta de Marcas</h3>
                       <div class="container py-3">
                          <a href="ConsultasS.php"><span class="icon-left-big"></span></a> Regresar a Consultas
                           <div class="card-body">
                              <form class="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                <input type="text" name="Serie" class="form-control" placeholder="Busqueda de equipo por Nombre de marca">
                                <br><button type="submit" name="submit" class="btn btn-success btn-sm btn-block" id="submit">Buscar</button>
                              </form>
                           </div>
