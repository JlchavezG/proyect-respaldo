             ...
             <div class="container-fluid">
                 ...
                 <h3 class="mt-4 text text-center">Consulta de Usuarios</h3>
                       <div class="container py-3">
                          ...
                          <div class="row">
                              <div class="container">
                               <a href="UsuariosS.php">Buscar por Nombre</a> | <a href="BU_Usuario.php">Buscar por Usuario</a> | <a href="Ue_Usuarios.php">Buscar por Email</a>
                              </div>
                          </div>
                           <div class="card-body">
                              <form class="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                <input type="text" name="Nombre" class="form-control" placeholder="Busqueda de usuario por Usuario">
